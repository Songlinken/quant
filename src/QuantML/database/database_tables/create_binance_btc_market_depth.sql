CREATE TABLE BINANCE_BTC_MARKET_DEPTH(
...
CREATE INDEX idx_binance_btc_market_depth_1 ON BINANCE_BTC_MARKET_DEPTH (TRADE_TIME);
CREATE INDEX idx_binance_btc_market_depth_2 ON BINANCE_BTC_MARKET_DEPTH (SYMBOL);