CREATE TABLE HUOBI_MARKET_DEPTH(
...
CREATE INDEX idx_huobi_market_depth_1 ON HUOBI_MARKET_DEPTH (EVENT_DATE);
CREATE INDEX idx_huobi_market_depth_2 ON HUOBI_MARKET_DEPTH (SYMBOL);