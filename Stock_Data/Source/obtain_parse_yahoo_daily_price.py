...
# set default relative dir
sys.path.append('/home/songlin/sguo/Quant/Stock_Data/obtain_parse_wiki_sp500_symbols.py')
...
class Obtain_parse_daily_price(object):

    def obtain_list_of_db_tickers(self):
    ...
    def get_daily_historic_data_yahoo(self, ticker, start_date=(2000, 1, 1), end_date=datetime.date.today().timetuple()[0:3]):
        """
